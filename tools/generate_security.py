...
security_doc = """# 🛡️ CircuitForge EDA Studio — Security & Hardware Safety Specification
...
Where:
- $\alpha$: Net switching activity factor.
...
with open(os.path.join(DOCS_DIR, "SECURITY.md"), "w", encoding="utf-8") as f:
    f.write(security_doc.strip() + "\\n")
print("Wrote docs/SECURITY.md successfully.")
